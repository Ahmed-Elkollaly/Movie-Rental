...
public class AddMovie extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            String movieName,actor1,actor2,actor3,actor4,year,rating,summary,trailerURl,rentPrice;
            String[] genres;
        ...
        movie.addMovie(movieName,genres_list,actors,year,rating,summary,trailerURl,rentPrice);
